...
export class UploadController {
  ...
  file(@Param('file') file: string, @Res() res: Response) {
    ...
    try {
      ...
      const fileStream = createReadStream(join(process.cwd(), '/www/wwwroot/carlosdj.com.br/files', file));
      ...
      fileStream.on('error', (err) => {
        ...
        const fileStream = createReadStream(
          join(process.cwd(), '/www/wwwroot/carlosdj.com.br/files', 'notfound.jpg'),
        );
        fileStream.pipe(res);
      });
    } catch (error) {
